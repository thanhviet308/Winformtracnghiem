        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ten_chuong = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ngay_tao = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_chuong_mon_hoc", x => x.id);
                    table.ForeignKey(
                        name: "FK_chuong_mon_hoc_mon_hoc_ma_mon",
                        column: x => x.ma_mon,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ma_mon = table.Column<long>(type: "bigint", nullable: true),
                    ma_chuong = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cau_hoi_thi_chuong_mon_hoc_ma_chuong",
                        column: x => x.ma_chuong,
                        principalTable: "chuong_mon_hoc",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cau_truc_de_chuong_mon_hoc_ma_chuong",
                        column: x => x.ma_chuong,
                        principalTable: "chuong_mon_hoc",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.InsertData(
                table: "nguoi_dung",
                columns: new[] { "id", "email", "ho_ten", "ma_vai_tro", "mat_khau", "ngay_tao" },
                values: new object[] { 1L, "admin@gmail.com", "Quản trị viên", 1L, "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
